    ...
    return(
        <>
            <div className="flex justify-center lg:items-center relative py-10">
                <img className="w-3/6 md:w-2/6" src="src/assets/images/playerhome.png" alt="Player Home" />
                <div className="text-center absolute bottom-0 lg:relative">
                    <h1 className="text-4xl font-bold lg:text-8xl ">PULSORA</h1>
                    <h2 className="text-3xl font-semibold lg:text-7xl text-blue-900">LOREM</h2>
                </div>
            </div>
            ...
            <div className=' my-20 text-center' >
                <button className='bg-blue-900 text-white font-semibold px-4 py-2 rounded-3xl  lg:text-xl  lg:px-6 lg:py-3 lg:rounded-full'  >DECOUVRIR</button>
            </div>
            ...
            <div className="flex flex-col lg:flex-row lg:h-[calc(100vh-4rem)] gap-6  m-20 text-center">
                <div className="bg-white text-slate-600 p-0 rounded-3xl flex-1 lg:h-full  relative">
                    <h2 className="text-2xl font-bold mt-4  lg:text-4xl  lg:mt-8">ARTICLE</h2>
                    <img className='w-1/3  mx-auto  lg:w-1/2' src="src/assets/images/stad.png" alt="" />
                    <div className='w-16 h-16 bg-blue-800  rounded-full  absolute right-2  bottom-2' >
                        <img className='w-1/2 mx-auto mt-4 -rotate-45 '  src="src/assets/images/right-arrow.png" alt="" />    
                    </div>             
                </div>
